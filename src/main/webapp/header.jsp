         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                 ...
                 <div class="col-sm-12">
                     <div class="logo">Mungmung Closet</div>
                  </div>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="fashion.html">About Us</a>
                     <a href="electronic.html">Top</a>
                     <a href="jewellery.html">Outer</a>
                     <a href="">Dog Item</a>
                     <a href="">SALE</a>
               ...
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">samplet</h1>
                              <div class="buynow_bt"><a href="#">sampletext</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">sampletext</h1>
